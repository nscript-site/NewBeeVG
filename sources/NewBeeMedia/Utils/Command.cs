...
public class Command : IDisposable
{
    ...
    public String ExecuteCmd(String fileName, String arguments, Action<String> onMsg, Action<String> onErr = null)
    {
        OnMsg = onMsg;
        OnErr = onErr;
    ...
    public String ExecuteCmd(String fileName, String arguments, Action<String> onMsg, Action<String> onErr, Char extSplitter)
    {
        OnMsg = onMsg;
        OnErr = onErr;
